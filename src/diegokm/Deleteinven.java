/*
This code delete the registers in maximo associated 
 */
package diegokm;
...
public class Deleteinven {
    ...
    public void readCsv(String strPlaca, String srtID) throws IOException, Exception {
        ...
        String IDVehiculo = "";
        try {
            br = new BufferedReader(new FileReader("A://delete.csv"));
    ...
    public void SendPost(String strID, String sParameters) throws Exception {
        ...
        String url = "https://rentingautomayor.maximo.com/maxrest_b1dk/rest/mbo/INVUSELINE/" + strID + "?_lid=" + sUser + "&_lpwd=" + sPassword;
    ...
    public void Leerxmlpapa() throws IOException {
        try {
            File archivo = new File("A://delete2.xml");
            DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
            DocumentBuilder documentBuilder = dbf.newDocumentBuilder();
            Document document = documentBuilder.parse(archivo);
            document.getDocumentElement().normalize();
            System.out.println("Elemento raiz:" + document.getDocumentElement().getNodeName());
            NodeList listaEmpleados = document.getElementsByTagName("INVUSELINE");
            ...
            for (int temp = 0; temp < listaEmpleados.getLength(); temp++) {
                ...
                if (nodo.getNodeType() == Node.ELEMENT_NODE) {
                   ...
                   String strID = element.getElementsByTagName("INVUSELINEID").item(0).getTextContent();
                    String strPlaca = element.getElementsByTagName("ROTASSETNUM").item(0).getTextContent();
