/*
This delete the purchase contract with the consesionarios, first you should donwload the xml whit the information.
 */
package diegokm;
...
public class DeleteCC {
    ...
    public void SendPost(String strID) throws Exception {
        ...
        String url = "https://rentingautomayor.maximo.com/maxrest_b1dk/rest/os/RA_SERVICES_ITEM/" + strID + "?_lid=" + sUser + "&_lpwd=" + sPassword;
        String sParameters = "";
    ...
    public void Leerxmlpapa() throws IOException {
        try {
            File archivo = new File("A://CONSE//CONTI.xml");
            DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
            DocumentBuilder documentBuilder = dbf.newDocumentBuilder();
            Document document = documentBuilder.parse(archivo);
            document.getDocumentElement().normalize();
            System.out.println("Elemento raiz:" + document.getDocumentElement().getNodeName());
            NodeList listaEmpleados = document.getElementsByTagName("INVVENDOR");
            ...
            for (int temp = 0; temp < listaEmpleados.getLength(); temp++) {
                ...
                if (nodo.getNodeType() == Node.ELEMENT_NODE) {
                   ...
                   String strID = element.getElementsByTagName("INVVENDORID").item(0).getTextContent();
